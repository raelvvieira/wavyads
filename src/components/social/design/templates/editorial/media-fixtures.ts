...
export const EDITORIAL_MEDIA_FIXTURES: TemplateMediaFixture[] = [
  {
    id: "none",
    label: "Sem imagem",
    description: "Valida a composicao quando o texto precisa liderar sozinho.",
  },
  {
    id: "balanced",
    label: "Equilibrada",
  ...
  },
  {
    id: "wide",
    label: "Muito larga",
    description: "Formato horizontal para testar corte e leitura.",
    imageUrl: wideImage,
  },
  {
    id: "tall",
