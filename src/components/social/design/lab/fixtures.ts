import type { TemplateFixture, TemplateFixtureId } from "@/components/social/design/templates/template-definition";

export type { TemplateFixture, TemplateFixtureId } from "@/components/social/design/templates/template-definition";

export const TEMPLATE_FIXTURES: TemplateFixture[] = [
  {
    id: "short",
    label: "Curta",
    description: "Titulos diretos e corpos de uma frase.",
    slides: [
  ...
  },
  {
    id: "medium",
    label: "Media",
    description: "Comprimento proximo do conteudo real do pipeline.",
    slides: [
      {
        tipo: "cover",
  ...
  },
  {
    id: "extreme",
    label: "Extrema",
    description: "Textos deliberadamente longos para revelar cortes e sobreposicoes.",
    slides: [
      {
        tipo: "cover",
        ...
        corpo: "Este titulo ultrapassa o tamanho recomendado de proposito para expor como cada template reage quando a copy chega maior do que o espaco planejado.",
      },
      {
        tipo: "problema",
...
export function getTemplateFixture(id: TemplateFixtureId): TemplateFixture {
  return TEMPLATE_FIXTURES.find((fixture) => fixture.id === id) ?? TEMPLATE_FIXTURES[1];
}
