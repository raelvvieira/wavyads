...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_project_state TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_assets TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_outputs TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_copy_variations TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_templates TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.creative_template_assets TO authenticated;
GRANT ALL ON public.creative_projects, public.creative_project_state, public.creative_assets, public.creative_outputs, public.creative_copy_variations, public.creative_templates, public.creative_template_assets TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.client_copy_bank TO authenticated;
GRANT ALL ON public.client_copy_bank TO service_role;
